    ...
    <div style="padding: 20px 0; margin: 0 20px">
      <a
        ...
        :href="`https://${config.public.urlPay}/services/pay/?service_id=32840&amount=${summa?.replace(
          / /g,
          '',
        )}&transaction_param=${patientData?.external_id}&return_url=https%3A%2F%2F${config.public.urlPay}%2Fapp%2FwebView%3Fauth%3Dtrue%26url%3Dhttps%253A%252F%252Fcredits.click.uz%2Fmain%2F${patientData?.id}`"
        class="paid-active"
      >
        {{ $t('paid-page.btn') }}</a
      >
